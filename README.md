...
**当前版本：[v1.9.9](https://github.com/zhangweildlh/chrome-md-editor/releases/tag/v1.9.9)**  
**下载（Chrome 扩展）：** [chrome-md-editor-v1.9.9.zip](https://github.com/zhangweildlh/chrome-md-editor/releases/download/v1.9.9/chrome-md-editor-v1.9.9.zip)  
**下载（Windows 独立 EXE）：** [Markdown.Editor_1.9.9_portable.exe](https://github.com/zhangweildlh/chrome-md-editor/releases/download/v1.9.9/Markdown.Editor_1.9.9_portable.exe)  
**许可：** [MIT](./LICENSE)
...
2. 关掉所有旧的编辑器标签，再新开一页。
3. 确认左上角版本徽标与 Release 一致（当前应为 **v1.9.9**）。
4. 桌面 EXE 用户：重新下载 `Markdown.Editor_1.9.9_portable.exe` 覆盖旧文件即可，无需卸载。
